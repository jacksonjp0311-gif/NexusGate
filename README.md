...
## Human Director Box
NEXUS GATE current line: v2.9.0 Geometric Language Intelligence Engine, layered on v2.8.0 Cybernetic Field Engine, v2.7.1 Breath Pulse, v2.7.0 Governed Experience Engine, v2.6.2 Causal Action Receipt Loop, v2.6.1 Epoch Integrity Seal, v2.6.0 Evidence Distillation Graph, Causal Coherence Routing, and Triadic Geometric Lattice. v2.9.0 adds AI Touch Intelligence Receipts, deterministic intelligence extraction, NGLM sparse activation, grounded language query, reversible motif compression, and language replay/benchmark surfaces. Use `ai-touch-begin`, `ai-touch-end`, `intelligence-extract`, `language-corpus-build`, `language-query`, `language-status`, `self-model-build`, `language-benchmark-smoke`, and `language-replay-verify`; the language engine can recommend and explain from evidence, but cannot execute, authorize, mutate source, or apply calibration. AI output is observation, not knowledge; no verified experience, no persistent weight change; no benchmark, no intelligence claim.
