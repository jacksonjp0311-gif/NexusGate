...
## Human Director Box
NEXUS GATE current line: v2.8.0 Cybernetic Field Engine, layered on v2.7.1 Breath Pulse, v2.7.0 Governed Experience Engine, v2.6.2 Causal Action Receipt Loop, v2.6.1 Epoch Integrity Seal, v2.6.0 Evidence Distillation Graph, Causal Coherence Routing, and Triadic Geometric Lattice. v2.8.0 adds semantic Breath regulation, a sparse Geometric Conductance Lattice, and a governed Telemetry Codec. Conductance may alter route preference; telemetry may describe context; neither can authorize action, bypass receipts, mutate source, or calibrate without verified experience and human authorization. Older version strings are subsystem lineage until deliberate migration; authority remains human-bound.
