...
class OriginSealV122Tests(unittest.TestCase):
    def test_origin_seal_packet_declares_current_product_identity(self) -> None:
        ...
        self.assertEqual(packet["schema"], "NEXUS_ORIGIN_SEAL.v2.1.0")
        self.assertEqual(packet["product_version"], "2.1.0")
        self.assertEqual(packet["product_phase"], "Causal Coherence Routing")
