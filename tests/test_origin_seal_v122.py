...
class OriginSealV122Tests(unittest.TestCase):
    def test_origin_seal_packet_declares_current_product_identity(self) -> None:
        ...
        self.assertEqual(packet["schema"], "NEXUS_ORIGIN_SEAL.v2.0.0")
        self.assertEqual(packet["product_version"], "2.0.0")
        self.assertEqual(packet["product_phase"], "Coherence Continuity Protocol")
