...
class TestNexusCellDoctrineV084(unittest.TestCase):
    ...
    def test_manifest_is_doctrine_only_and_ui_visible(self):
        ...
        self.assertIn(manifest["status"], {"doctrine_manifest_ui_access_only", "read_only_planner_enabled_no_execution", "compiler_visible_planner_no_execution", "context_bridge_visible_no_execution", "operator_shell_visible_no_execution"})
