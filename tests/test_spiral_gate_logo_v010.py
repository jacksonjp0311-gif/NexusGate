...
class TestSpiralGateLogoV010(unittest.TestCase):
    ...
    def test_logo_is_compact_and_has_no_backing_box(self):
        ...
        self.assertIn("width: 380px", text)
        self.assertIn("width: 72px", text)
        self.assertIn("--nexus-gate-bronze", text)
        self.assertIn("nexus-gate-bronze-ring", text)
        self.assertIn("nexus-gate-rune-track", text)
    ...
    def test_gear_vortex_and_send_hooks_remain(self):
        ...
        self.assertIn("nexus-rune-band", text)
        self.assertIn("nexus-gate-vortex-wake", text)
