...
def build(root: str | Path) -> dict:
    ...
    packet = {
        ...
        "status": "pass",
        "version_evidence": "v2.10.0 NEX Cognitive Cycle Engine" if "v2.10.0" in readme else ("v2.9.0 Geometric Language Intelligence Engine" if "v2.9.0" in readme else "v2.8.0 baseline or updating"),
        "command_count": len(commands),
        "commands": commands,
        "capabilities": ["ai_touch_receipts", "deterministic_intelligence_extraction", "sparse_language_activation", "grounded_query", "conductance_preference", "nex_core_direct_chat", "typed_inner_messages", "teaching_episode_seals"],
        "experimental_capabilities": ["geometric_token_field", "motif_compression", "language_conductance_calibration", "bounded_geometric_learning_proposals"],
