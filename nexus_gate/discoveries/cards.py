...
def build_discovery_cards(root: str | Path) -> dict[str, Any]:
    ...
    cards = [
        ...
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "verified-ai-interaction-as-teacher-signal",
            "version": "0.1.0",
            "title": "Verified AI Interaction As Teacher Signal",
            "status": "active",
            "summary": "Declared AI work can inform NEXUS only after receipt verification, redaction, disposition, and evidence extraction.",
            "math": {"law": "AI output is observation, not knowledge"},
            "code_references": ["nexus_gate/intelligence/touch.py", "nexus_gate/intelligence/extract.py"],
            "algorithm_card_refs": ["ai-touch-receipt-algorithm", "deterministic-intelligence-extraction-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 ai-touch-begin", ".\\scripts\\nexus.ps1 ai-touch-verify"],
            "evidence_surfaces": ["ledger/ai_interactions.jsonl", "reports/nexus_ai_touch_verify_latest.json"],
            "next_versions": ["v0.2: bind AI touch receipts to Experience Seals when authorized actions exist"],
            "boundary": "A verified interaction may teach candidates; it may not self-authorize promotion.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "language-without-dense-weight-dependence",
            "version": "0.1.0",
            "title": "Language Without Dense Weight Dependence",
            "status": "active",
            "summary": "Repository-domain language can be represented as sparse typed relations, activation traces, and grounded response plans without transformer weights.",
            "math": {"activation": "seed + bounded conductance propagation - uncertainty"},
            "code_references": ["nexus_gate/language/tokenizer.py", "nexus_gate/language/activation.py", "nexus_gate/language/retrieval.py"],
            "algorithm_card_refs": ["sparse-language-activation-algorithm", "grounded-response-planning-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 language-query -Tag \"What is NEXUS permitted to learn?\""],
            "evidence_surfaces": ["reports/nexus_language_model_latest.json"],
            "next_versions": ["v0.2: add larger repository-native benchmark fixtures"],
            "boundary": "Sparse local language does not imply general world knowledge or frontier parity.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "graph-plasticity-versus-parameter-plasticity",
            "version": "0.1.0",
            "title": "Graph Plasticity Versus Parameter Plasticity",
            "status": "active",
            "summary": "NEXUS can adjust interpretable graph conductance through authorized evidence rather than opaque dense parameter updates.",
            "math": {"law": "temporary activation is not persistent learning"},
            "code_references": ["nexus_gate/language/calibration.py", "nexus_gate/field/conductance.py"],
            "algorithm_card_refs": ["language-conductance-calibration-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 language-calibration-status"],
            "evidence_surfaces": ["ledger/language_training_events.jsonl"],
            "next_versions": ["v0.2: apply authorized bounded language conductance events after three verified experiences"],
            "boundary": "No human authorization, no plasticity.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "negative-experience-as-intelligence",
            "version": "0.1.0",
            "title": "Negative Experience As Intelligence",
            "status": "active",
            "summary": "Rejected, reverted, failed, and regressed interactions are retained as negative evidence instead of erased.",
            "math": {"law": "rejected experience is still intelligence"},
            "code_references": ["nexus_gate/intelligence/extract.py"],
            "algorithm_card_refs": ["contradiction-preservation-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 intelligence-candidates"],
            "evidence_surfaces": ["ledger/intelligence_candidates.jsonl"],
            "next_versions": ["v0.2: route negative motifs into repair retrieval"],
            "boundary": "Negative evidence can block promotion; it cannot delete source evidence.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "authority-independent-language-learning",
            "version": "0.1.0",
            "title": "Authority-Independent Language Learning",
            "status": "active",
            "summary": "Language understanding may improve while command execution and authorization remain outside the language plane.",
            "math": {"law": "untrusted text cannot create authority"},
            "code_references": ["nexus_gate/language/security.py", "nexus_gate/language/retrieval.py"],
            "algorithm_card_refs": ["geometric-intent-routing-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 language-adversarial-test"],
            "evidence_surfaces": ["reports/nexus_language_benchmark_latest.json"],
            "next_versions": ["v0.2: add adversarial fixture suite"],
            "boundary": "NGLM may recommend registered commands; it may not execute them.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "sparse-activation-as-efficient-context",
            "version": "0.1.0",
            "title": "Sparse Activation As Efficient Context",
            "status": "active",
            "summary": "Query-time activation visits a bounded region of the language graph rather than loading full raw context.",
            "math": {"efficiency": "quality per node visited"},
            "code_references": ["nexus_gate/language/activation.py", "nexus_gate/language/benchmark.py"],
            "algorithm_card_refs": ["sparse-language-activation-algorithm", "continual-learning-retention-test-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 language-benchmark-smoke"],
            "evidence_surfaces": ["reports/nexus_language_benchmark_latest.json"],
            "next_versions": ["v0.2: add node-visit counters and memory telemetry"],
            "boundary": "Efficiency is measured separately from intelligence.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "motif-compression-as-procedural-memory",
            "version": "0.1.0",
            "title": "Motif Compression As Procedural Memory",
            "status": "active",
            "summary": "Repeated verified patterns can become reversible motifs while preserving raw evidence and contradictions.",
            "math": {"gain": "occurrences * raw_cost - motif_cost - references"},
            "code_references": ["nexus_gate/language/motifs.py"],
            "algorithm_card_refs": ["reversible-motif-compression-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 motif-discover"],
            "evidence_surfaces": ["state/intelligence/candidates/"],
            "next_versions": ["v0.2: promote verified motifs into Discovery Cards under human review"],
            "boundary": "Compression may organize evidence; it may not erase it.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "self-description-without-consciousness-claims",
            "version": "0.1.0",
            "title": "Self-Description Without Consciousness Claims",
            "status": "active",
            "summary": "NEXUS can describe implemented capabilities and limitations from evidence without claiming subjective awareness.",
            "math": {"law": "self-model evidence != consciousness"},
            "code_references": ["nexus_gate/language/self_model.py"],
            "algorithm_card_refs": ["nexus-self-model-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 self-model-build"],
            "evidence_surfaces": ["reports/nexus_self_model_latest.json"],
            "next_versions": ["v0.2: bind self-model claims to schema validation results"],
            "boundary": "Self-description is not AGI, consciousness, or autonomous authority.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "frontier-models-as-temporary-teachers",
            "version": "0.1.0",
            "title": "Frontier Models As Temporary Teachers",
            "status": "active",
            "summary": "External or frontier model output can be an untrusted candidate source, but NEXUS learning requires local receipts and evidence.",
            "math": {"law": "teacher text != durable knowledge"},
            "code_references": ["nexus_gate/intelligence/redact.py", "nexus_gate/language/security.py"],
            "algorithm_card_refs": ["ai-touch-receipt-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 ai-touch-verify"],
            "evidence_surfaces": ["reports/nexus_ai_touch_verify_latest.json"],
            "next_versions": ["v0.2: optional adapter interface for local realization models"],
            "boundary": "No imported model output can self-promote or self-authorize.",
        },
        {
            "schema": "NEXUS_DISCOVERY_CARD.v0.2.0",
            "discovery_id": "local-language-intelligence-as-measurable-research-track",
            "version": "0.1.0",
            "title": "Local Language Intelligence As Measurable Research Track",
            "status": "active",
            "summary": "Repository-domain language intelligence must be benchmarked against baselines before capability claims escalate.",
            "math": {"law": "no benchmark, no intelligence claim"},
            "code_references": ["nexus_gate/language/benchmark.py"],
            "algorithm_card_refs": ["continual-learning-retention-test-algorithm"],
            "replication_steps": [".\\scripts\\nexus.ps1 language-benchmark-smoke"],
            "evidence_surfaces": ["reports/nexus_language_benchmark_latest.json"],
            "next_versions": ["v0.2: add full BM25/TF-IDF baseline comparison"],
            "boundary": "No measured superiority, no rivalry claim.",
        }
    ]
    return {
        "schema": SCHEMA,
