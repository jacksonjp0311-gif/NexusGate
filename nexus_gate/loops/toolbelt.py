...
GROUPS = [
    ...
    {"group_id":"debug","title":"Debug","purpose":"Narrow failures into wounds.","loops":["debug-lens","wound-indexed-resume","wound-compression-engine","compiler-wound-focus","debug-recovery-chain","failure-intelligence","friction-detector"],"chain":"debug-lens -> wound-indexed-resume -> compiler-wound-focus"},
