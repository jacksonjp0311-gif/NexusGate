...
The root README stays readable. Long version history, rehydration notes, and UI geometry lessons live here.

## Current line

```text
v0.7.4 HANDOFF action shell bridge
v0.7.5 HANDOFF report persistence
v0.7.6 Dev Mode / Handoff Console
...
```text
README.md
docs/versioning/NEXUS_VERSIONING_REHYDRATION.md
docs/failure_modes/NEXUS_FAILURE_MODE_DOCTOR.md
state/failure_modes/nexus_failure_modes.v0.7.9.json
