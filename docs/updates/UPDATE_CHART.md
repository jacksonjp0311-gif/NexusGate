...
| v2.5.0 | Triadic Geometric Lattice | current | Adds evidence + geometry + authority lattice alignment to recommendation routing and exposes a `triadic-lattice` gate. |
