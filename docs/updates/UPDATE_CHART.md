...
| v1.3.0 | Canonical Decision Envelope | current | Adds self-bootstrap decision-envelope lane, report/state packet, docs, cards, and evolve-chain integration after Origin Seal. |
