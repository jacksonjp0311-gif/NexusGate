...
| v2.6.0 | Evidence Distillation Graph | current | Distills heavy evidence into hash-backed graph nodes, biological-efficiency principles, emergence motifs, and recommendation-only pruning policy. |
