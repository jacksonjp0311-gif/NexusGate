...
v0.9.4 expands cards into a personal coding paradise: creative planning, debug recovery, command palette, local oracle, docs weaving, continuity seal, and safe shipping loops.
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop architecture-sketch --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop code-garden-map --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop command-palette --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop commit-story --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop continuity-seal --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop creative-build-chain --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop debug-lens --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop debug-recovery-chain --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop docs-weaver --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop friction-detector --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop idea-forge --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop local-oracle --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop memory-anchor --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop pair-programming-brief --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop paradise-index --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop paradise-preflight --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop patch-plan --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop performance-scout --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop refactor-map --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop risk-register --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop safe-ship-chain --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop session-brief --intent "<intent>" --execute --human-authorized --json`
...
- Execute: `python -m nexus_gate.loops.runner --root . --loop ui-polish --intent "<intent>" --execute --human-authorized --json`
