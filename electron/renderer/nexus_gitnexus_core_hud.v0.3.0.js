(() => {
    ...
    hud.innerHTML =
      '<div class="gitnexus-big-top">' +
        ...
        '<div class="gitnexus-search">' +
          ...
          '<button class="gitnexus-control-btn" data-gn-rotate>Turn</button>' +
  ...
  function drawMini(canvas, report) {
    ...
    const cx = canvas.width / 2;
    const cy = canvas.height / 2;
    const count = Math.min(28, Math.max(8, Math.floor((report?.counts?.edges || 40) / 20)));
  ...
  function ensureDock() {
    ...
    dock.innerHTML =
      '<section id="gitnexus-core-station" class="gitnexus-core-station">' +
        ...
        '<div class="gitnexus-mini-canvas-wrap"><canvas id="gitnexus-mini-canvas"></canvas><div class="gitnexus-mini-label"><span>Mini Graph</span><span>Live</span></div></div>' +
        '<button type="button" class="gitnexus-core-button">Open Interactive Nexus HUD</button>' +
        ...
        '</div>' +
        '<div class="gitnexus-core-note">Mini codegraph + full interactive explorer.</div>' +
      '</section>';
