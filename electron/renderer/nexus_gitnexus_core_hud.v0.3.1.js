(() => {
    ...
    hud.innerHTML =
      '<div class="gitnexus-big-top">' +
        ...
        '<div class="gitnexus-search">' +
          ...
          '<button class="gitnexus-control-btn" data-gn-rotate-left>âŸ²</button><button class="gitnexus-control-btn" data-gn-rotate>Turn</button><button class="gitnexus-control-btn" data-gn-rotate-right>âŸ³</button>' +
  ...
  function bindHudControls(hud, canvas) {
    ...
    hud.querySelector("[data-gn-rotate]").onclick = () => { state.transform.rotation += Math.PI / 12; };`r`n    hud.querySelector("[data-gn-rotate-left]").onclick = () => { state.transform.rotation -= Math.PI / 18; };`r`n    hud.querySelector("[data-gn-rotate-right]").onclick = () => { state.transform.rotation += Math.PI / 18; };
