(() => {
    ...
    hud.innerHTML =
      '<div class="gitnexus-big-top">' +
        ...
        '<div class="gitnexus-search">' +
          ...
          '<button class="gitnexus-control-btn" data-gn-rotate-left>ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â²</button><button class="gitnexus-control-btn" data-gn-rotate>Turn</button><button class="gitnexus-control-btn" data-gn-rotate-right>ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³</button>' +
  ...
  function sanitizeToolbarLabels() {
    try {
      ...
      document.querySelectorAll("button, [role='button'], .gitnexus-control-btn").forEach((node) => {
